<section class="od-trust pt-56 pb-56 pt-sm-64 pb-sm-64 pt-lg-96 pb-lg-96 pt-xxxl-132 pb-xxxl-132">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex flex-column gap-8 align-items-center">
                    <h2 class="h5 fw-bolder c-body">Zaufali nam</h2>
                    <p class="p-m">Placeholder opinii klient&#243;w</p>
                </div>
            </div>
        </div>
        <div class="row mt-48">
                                ...
                                <div class="od-trust-card-stars">
                                    <div class="od-trust-card-star">
                                        <svg class="i-sprite icon-24">
                                            <use href="/sprites/icons-24.svg#star_fill"></use>
                                        </svg>
                                    </div>
                                    <div class="od-trust-card-star">
                                        <svg class="i-sprite icon-24">
