...
$cta = $has_acf ? get_field( 'help_cta', 'option' ) : array();
...
<section class="about-cta bg-white pt-56 pb-56 pt-sm-64 pb-sm-64 pt-lg-96 pb-lg-96"<?php echo $heading ? ' aria-labelledby="help-cta-heading"' : ''; ?>>
	<div class="container">
		<?php if ( $heading || $text ) : ?>
			<div class="row">
				<div class="col-12">
					<div class="d-flex flex-column gap-24 justify-content-center">
						<?php if ( $heading ) : ?>
							<h2 id="help-cta-heading" class="h5 fw-bolder c-body text-center"><?php echo wp_kses_post( $heading ); ?></h2>
						<?php endif; ?>
						<?php if ( $text ) : ?>
